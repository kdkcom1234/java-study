...
// 일반적으로 class는 public 거이
// class 이름은 파스칼케이스(대문자시작단어+대문자시작단어...., pascal-case)
// 그외, kebab-case(order-info, 주소url, 사이트명칭, 컴포넌트이름..., 소문자 단어사이에 -)
// snake-case(order_info, 데이터베이스시스템, 단어사이에 underscore를 씀, 단어는 주로 소문자이나, 대문자만으로 하는 경우있음)
// ORDER_INFO
...
//        return temp;
    ...
    /*
     [공개범위(public/private)] [반환타입(String, void)] [메서드이름](매개변수, 매개변수2.. ) {
        실행되는 코드 ...
        [return 반환값]
     }
     */
